"""
Django settings for demo_test_jkozel_40851 project.
...
ROOT_URLCONF = 'demo_test_jkozel_40851.urls'
...
WSGI_APPLICATION = 'demo_test_jkozel_40851.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "demo_test_jkozel_40851 API",
    "DESCRIPTION": "API documentation for demo_test_jkozel_40851 App",
    "VERSION": "v1",
}
